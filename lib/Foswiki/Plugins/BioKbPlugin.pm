...
# This should always be $Rev: 4684 $ so that Foswiki can determine the checked-in
# status of the plugin. It is used by the build automation tools, so
# you should leave it alone.
our $VERSION = '$Rev: 4684 $';

# This is a free-form string you can use to "name" your own plugin version.
# It is *not* used by the build automation tools, but is reported as part
# of the version number in PLUGINDESCRIPTIONS.
our $RELEASE = '$Date: 2009-08-18 16:13:53 +0100 (Tue, 18 Aug 2009) $';

# Short description of this plugin
# One line description, is shown in the %SYSTEMWEB%.TextFormattingRules topic:
our $SHORTDESCRIPTION = 'Set of functions to create and populate a biological knowledgebase from online resources, ready for comment, annotation and discussion by a community.';
...
sub initPlugin {
    ...
    # like this:
    # $Foswiki::cfg{Plugins}{BioKbPlugin}{ExampleSetting} = 1;
    ...
    # my $setting = $Foswiki::cfg{Plugins}{BioKbPlugin}{ExampleSetting} || 0;
...
1;
__END__
This copyright information applies to the BioKbPlugin:

# Plugin for Foswiki - The Free and Open Source Wiki, http://foswiki.org/
#
# BioKbPlugin is # This program is distributed in the hope that it will be useful,
# but WITHOUT ANY WARRANTY; without even the implied warranty of
